		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-4">
					...
					onclick="ocultaElementoPorClasse('div_2')"">Esconder divs</button>
					<button type="button" class="btn btn-success" onclick="exibeElementoPorClasse('div_2')">Exibir divs</button>
				</div>

				<div class="col-md-4">
					<button type="button" class="btn btn-danger" onclick="ocultaElementoPorId('1'); ocultaElementoPorId('2')">Esconder inputs</button>
					<button type="button" class="btn btn-success" onclick="exibeElementoPorId('1'); exibeElementoPorId('2')" >Exibir inputs</button>
				</div>
